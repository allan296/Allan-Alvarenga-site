---
title: "Como transformar uma matriz de distância em formato tidy (arrumado)"
author: |
  |
  |
...
Sugestão de citação: Alvarenga A.M.S.B. RPubs - Como transformar uma matriz de distância em formato tidy (arrumado) [Internet]. 2019 [cited 2019 Sep 11]. Available from: http://rpubs.com/allan_alvarenga/dist2tidy
...
## Plot padrão
```{r Plot padrão, message=FALSE, warning=FALSE, paged.print=FALSE}
